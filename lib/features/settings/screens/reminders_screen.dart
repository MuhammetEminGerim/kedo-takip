...
class _RemindersScreenState extends ConsumerState<RemindersScreen> {
  ...
  void _showAddReminderDialog(String type) {
    ...
    String chosenCatId = selectedCat?.id ?? cats.first.id;
    String chosenCatName = selectedCat?.name ?? cats.first.name;
        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: Text(AppStrings.get('add_reminder'), style: const TextStyle(fontWeight: FontWeight.w900, color: Colors.white)),
            ),
          ],
        ),
      ),
